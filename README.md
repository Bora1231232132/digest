...
_Note: A popup will appear asking if you want to create a new file. Click **Yes**._
...
_If using PowerShell (default in VS Code/Windows 11):_

```powershell
$env:GEMINI_API_KEY="your_api_key_here"
```

_If using classic Command Prompt (cmd):_
